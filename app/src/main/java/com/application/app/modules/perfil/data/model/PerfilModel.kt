package com.application.app.modules.perfil.`data`.model

import com.application.app.R
import com.application.app.appcomponents.di.MyApp
import kotlin.String

public data class PerfilModel(
  /**
  ...
  public var txtSubirFoto: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_subir_foto)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  public var txtBirthday: String? = MyApp.getInstance().resources.getString(R.string.lbl_birthday)
  ,
  /**
   * TODO Replace with dynamic value
   */
