...
public class ActivityApuntes2BindingImpl extends ActivityApuntes2Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.scrollViewScrollview, 15);
        sViewsWithIds.put(R.id.constraintGroup213, 16);
        sViewsWithIds.put(R.id.imageGroup32, 17);
        sViewsWithIds.put(R.id.constraintGroup202, 18);
        sViewsWithIds.put(R.id.imageCalendarDate, 19);
        sViewsWithIds.put(R.id.constraintGroup214, 20);
        sViewsWithIds.put(R.id.constraintGroup209, 21);
        sViewsWithIds.put(R.id.imageRectangle17, 22);
        sViewsWithIds.put(R.id.imageInterfaceRemov, 23);
        sViewsWithIds.put(R.id.imageGroup, 24);
        sViewsWithIds.put(R.id.viewRectangle, 25);
        sViewsWithIds.put(R.id.viewRectangle3, 26);
        sViewsWithIds.put(R.id.imageView6, 27);
        sViewsWithIds.put(R.id.imageView8, 28);
        sViewsWithIds.put(R.id.imageView9, 29);
    }
    // views
    // variables
    // values
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.txtDescarga, apuntes2VMApuntes2ModelTxtVer1);
